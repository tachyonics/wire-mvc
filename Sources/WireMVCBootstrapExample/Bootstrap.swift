...
// `@WireMVCBootstrap` makes the plugin generate the program entry point (`@main`) and the companion
// `withTestServer` entry. There is no `main.swift` and no hand-written `@main` — `swift run
