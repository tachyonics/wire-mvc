...
// `@Replaces FakeGreeter` supersedes the app's `RealGreeter`. The generated `withTestServer`
// serves that fake graph on an ephemeral port; `GET /hello/Alice` returns the fake's response.

@Suite("Replaced greeter via @Replaces")
struct ReplaceTests {
